                            ...
                            <div className="accordion-container-one">
                                ...
                                <Accordion defaultActiveKey="0">
                                    <Accordion.Item eventKey="0">
                                        <Accordion.Header>How long has AITweak been in business?</Accordion.Header>
                                        <Accordion.Body>
                                    ...
                                    <Accordion.Item eventKey="1">
                                        <Accordion.Header>What types of services does AITweak offer?</Accordion.Header>
                                        <Accordion.Body>
                                            Offers a unified platform that fosters innovation while
                                            providing end-to-end data management. See how we help your
                                            team solve today’s biggest challenges.
                                    ...
                                    <Accordion.Item eventKey="2">
                                        <Accordion.Header>Does AITweak work with small businesses or only large
                                    ...
                                    <Accordion.Item eventKey="3">
                                        <Accordion.Header>What technologies does AITweak specialize in?</Accordion.Header>
                                        <Accordion.Body>
                                            Offers a unified platform that fosters innovation while
                                            providing end-to-end data management. See how we help your
                                            team solve today’s biggest challenges.
                                    ...
                                    <Accordion.Item eventKey="4">
                                        <Accordion.Header>How does AITweak stay up-to-date with the latest technology
                                    ...
                                    <Accordion.Item eventKey="5">
                                        <Accordion.Header>How do I get started with AITweak?</Accordion.Header>
                                        <Accordion.Body>
                                            Offers a unified platform that fosters innovation while
                                            providing end-to-end data management. See how we help your
                                            team solve today’s biggest challenges.
