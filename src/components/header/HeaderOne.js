...
function HeaderOne() {
  ...
  return (
    <div>
            ...
            <div className="col-lg-12">
              <div className="header-wrapper-1">
                ...
                <div className="button-area-right-header">
                  ...
                  <div className="menu-btn-toggle d-lg-none" onClick={toggleSidebar}>
                    <svg
                      width={20}
                      height={16}
                      viewBox="0 0 20 16"
      ...
      <header
        className={`header-style-one header--sticky ${isSticky ? "sticky" : ""}`}
      >
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="header-wrapper-1">
                ...
                <div className="button-area-right-header">
                  ...
                  <div
                    id="menu-btn"
                    className="menu-btn-toggle d-lg-none"
