...
export const metadata = {
  title: "AiTweak -  AI solutions for a growing businesses",
  description: " AI solutions for a growing businesses",
  icons: {
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <Head>
        <title>AiTweak -  AI solutions for a growing businesses</title>
        <meta name="author" content="reactheme" />
        <meta name="description" content="AiTweak -  AI solutions for a growing businesses" />
